...
<head>
    ...
    <link href="/cPanel_magic_revision_1680035918/unprotected/cpanel/style_v2_optimized.css" rel="stylesheet" type="text/css" />
...
.copyright {
  ...
  background-size: 25px auto;
    ...
    <style type="text/css">
        img {
            behavior: url(/cPanel_magic_revision_1680035918/unprotected/cp_pngbehavior_login.htc);
        }
    </style>
    <![endif]-->
    ...
    <div id="notify">
        <noscript>
            <div class="error-notice">
                <img src="/cPanel_magic_revision_1680025402/unprotected/cpanel/images/notice-error.png" alt="Error" align="left"/>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    <div id="login-sub-header">
                        ...
                        <img class="main-logo" src="/cPanel_magic_revision_1680025402/unprotected/cpanel/images/cpanel-logo.svg" alt="logo" />
                        ...
                        <div id="forms">
                            <form novalidate id="login_form" action="/login/" method="post" target="_self" style="visibility:">
                                ...
                                <div class="input-field-login icon username-container">
                                    <input name="user" id="user" autofocus="autofocus" value="" placeholder="قم بإدخال اسم المستخدم." class="std_textbox" type="text"  tabindex="1" required>
                                </div>
                                <div class="input-req-login login-password-field-label"><label for="pass">كلمة المرور</label></div>
                                <div class="input-field-login icon password-container">
                                    <input name="pass" id="pass" placeholder="أدخل كلمة المرور الخاصة بحسابك." class="std_textbox" type="password" tabindex="2"  required>
                                </div>
                                <div class="controls">
                                    <div class="login-btn">
...
<script>
    var MESSAGES = {"session_locale":"تم حفظ الإعدادات المحلية المفضلة للمستعرض الخاص بك. لتغيير الإعدادات المحلية في هذا المستعرض مرة أخرى، حدد لغة أخرى في هذه الشاشة.","ajax_timeout":"انتهت مهلة الاتصال. يرجى المحاولة مرة أخرى.","invalid_login":"تسجيل الدخول غير صالح.","internal_error":"An internal error occurred. If this condition persists, contact the system administrator.","read_below":"اقرأ المعلومات الهامة الموجودة أدناه.","success":"تسجيل دخول ناجح. جارٍ إعادة التوجيه…","no_username":"يجب تحديد اسم مستخدم لتسجيل الدخول.","authenticating":"جارٍ المصادقة…","network_error":"حدث خطأ في الشبكة أثناء طلب تسجيل الدخول الخاص بك. يرجى المحاولة مرة أخرى. وإذا استمرت هذه المشكلة، فيرجى الاتصال بموفر خدمة الشبكة لديك."};
